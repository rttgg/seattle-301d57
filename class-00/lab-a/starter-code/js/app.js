...
function displayPics(){
  ...
  // When we change var to let on rando function which it was a global function but changing it to let will make to a local function. So we have to find a way to call the local function.
  console.log(viewed);
