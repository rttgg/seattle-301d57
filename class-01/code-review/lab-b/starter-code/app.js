...
const pEl = document.getElementById('clickMe');
...
pEl.addEventListener('click', (event, err) => {
  console.log(event.target);
})

// Bad constructor

// const StudentStudent = (name, coolness) => ({
//   name: name,
//   coolness: coolness * 60,
//   sayHi: () => 'hi',
// })
...
// function(course){
//   return `I cam currently enrolled in ${course}`;
// }
// TODO: Uncomment the following line of code to see the output in the browser console
